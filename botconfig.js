module.exports = {
  ...
  SupportServer: "https://www.youtube.com/watch?v=rS94ibzYCJY", // Support Server Link
  Token: process.env.Token || "MTA0NjQ4NTA0MDE1MTkyNDg3OA.GaJfZw.uCeF6knKhFB9aE1ukGAsK5fXSbbaxNWUKT0F5Y", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1046485040151924878", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "5HbyN8k4wX8LymP3m8vatsROuGfBzPg9", // Discord Client Secret
  ...
  CookieSecret: "Pikachu is not cute", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Presence: {
    ...
    name: "música hacendado", // The message shown
